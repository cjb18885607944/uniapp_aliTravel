...
var homeload = function homeload() {__webpack_require__.e(/*! require.ensure | common/components/homeload/homeload */ "common/components/homeload/homeload").then((function () {return resolve(__webpack_require__(/*! ./common/components/homeload/homeload.vue */ 56));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('homeload', homeload); // 引入loading
var loading = function loading() {__webpack_require__.e(/*! require.ensure | common/components/loading/loading */ "common/components/loading/loading").then((function () {return resolve(__webpack_require__(/*! ./common/components/loading/loading.vue */ 63));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('myLoading', loading); // 没有数据的提示组件
var nodata = function nodata() {__webpack_require__.e(/*! require.ensure | common/components/nodata/nodata */ "common/components/nodata/nodata").then((function () {return resolve(__webpack_require__(/*! ./common/components/nodata/nodata.vue */ 70));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('none-data', nodata); // 自定义模态框
var modal = function modal() {__webpack_require__.e(/*! require.ensure | common/components/modal/modal */ "common/components/modal/modal").then((function () {return resolve(__webpack_require__(/*! ./common/components/modal/modal.vue */ 77));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('modal', modal); // 引入动画css
