<template>
	<view>
		...
		<view class="upload">
			...
			<!-- 标题 -->
			<view class="uploadTitle"><input type="text" placeholder="给旅行日记一个标题吧" class="titleInput" v-model="uploadTitle" /></view>
			<!-- 内容 -->
			<view class="uploadCon"><textarea v-model="uploadContent" placeholder="描述下你的心得与心情,帮助更多旅行的人" /></view>
			<!-- 上传图片 -->
			<view class="uploadImage">
				<view class="cameraImg"><image src="/static/tab/topimg.png" mode="widthFix" @tap="uploadImg"></image></view>
				<!-- 九宫格 -->
			...
			<view class="uploadVidep">
				<view class="videoImg"><image src="/static/tab/topvideo.png" mode="widthFix" @tap="uploadVideo"></image></view>
		...
		<!-- 定位 -->
		<view class="address">
			<view class="addressTitle">你在哪里</view>
		...
		<!-- 发布 -->
		<view class="release" @click="isSubmit">发布</view>
	</view>
</template>
